...
// contains the x & y positionso i can use to draw the
// box on the canvas
...
// 4. Create gameboard array so i know where other squares are
...
// Also delete the previously drawn shape and draw the new one
...
// Do the same stuff when i drew originally
...
function RotateTetromino()
{
    ...
    for(let i = 0; i < tetrominoCopy.length; i++)
    {
        ...
        // Cloning the array otherwise it would 
...
// so i can orientate all other squares using that as
